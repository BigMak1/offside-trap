...
(function (global) {
  ...
  var DICT = {
    en: {
      ...
      lost_caught: "You ran into a defender. Read the numbers!",
      ...
      rule_number_t: "Number", rule_number_d: " — how many defenders sit in the 8 neighbouring cells. Read it to tell safe cells from defenders. A 0 opens a cascade.",
      ...
      squad_intro: "Defenders are mines — opening one loses the run. The number on a safe cell is how many defenders surround it; read the board to find the safe path.",
      squad_def: "Defender", squad_def_sub: "a mine — avoid it",
    ...
    ru: {
      ...
      lost_caught: "Налетел на защитника. Читай числа!",
      ...
      rule_number_t: "Число", rule_number_d: " — сколько защитников в 8 соседних клетках. По нему отличаешь безопасные клетки от защитников. 0 раскрывает каскад.",
      ...
      squad_intro: "Защитники — мины: вскрыл одного и забег проигран. Число на безопасной клетке — сколько защитников вокруг; читай доску, чтобы найти безопасный путь.",
      squad_def: "Защитник", squad_def_sub: "мина — обходи",
